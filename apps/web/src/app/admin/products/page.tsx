...
const FALLBACK_ADMIN_PRODUCTS: AdminProduct[] = [
  {
    ...
    brand: { id: 'brand-001', name: 'Nayan Sukh Masterworks' },
    category: { id: 'cat-001', name: 'Eyeglasses' },
    variants: [
      { id: 'var-1', sku: 'NS-OPT-001-BLK', color: 'Obsidian Black', stock: 24, price: 3499, isActive: true },
      { id: 'var-2', sku: 'NS-OPT-001-TOR', color: 'Dark Amber Tortoise', stock: 18, price: 3499, isActive: true },
    ],
  ...
  },
  {
    ...
    variants: [
      { id: 'var-3', sku: 'NS-SUN-002-GLD', color: 'Champagne Gold', stock: 15, price: 4999, isActive: true },
      { id: 'var-4', sku: 'NS-SUN-002-SIL', color: 'Brushed Silver', stock: 8, price: 4999, isActive: true },
    ],
  ...
  },
  {
    ...
    category: { id: 'cat-001', name: 'Eyeglasses' },
    variants: [
      { id: 'var-5', sku: 'NS-OPT-003-SMK', color: 'Smoke Crystal', stock: 32, price: 3899, isActive: true },
    ],
  ...
  },
  {
    ...
    category: { id: 'cat-002', name: 'Sunglasses' },
    variants: [
      { id: 'var-6', sku: 'NS-SUN-004-MAT', color: 'Matte Titanium', stock: 12, price: 5499, isActive: true },
    ],
